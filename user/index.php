        ...
        <section class="content">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="box box-solid">
                        <div class="box-header">
                            <h3 class="box-title">老虎机摇奖获取流量</h3>
                        </div><!-- /.box-header -->
                        <div class="box-body">
                            <p> 老虎机模式 </p>
                            <p>每3天需摇奖一次，否则删号处理(500G以上用户不受此约束)。</p>
                            <?php  if($oo->is_able_to_check_in())  { ?>
                                <p id="checkin-btn"> <button id="checkin" class="btn btn-success  btn-flat">摇奖</button></p>
                            <?php  }else{ ?>
                                <p id="checkin-btn"> <button id="checkin" class="btn btn-success  btn-flat">摇奖</button></p>
                            <?php  } ?>
                            <p id="checkin-msg" ></p>
                            <p>上次摇奖时间：<code><?php echo date('Y-m-d H:i:s',$oo->get_last_check_in_time());?></code></p>
                        </div><!-- /.box-body -->
                    </div><!-- /.box -->
                </div><!-- /.col (right) -->
